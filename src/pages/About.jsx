...
const ServiceCarousel = () => {
  ...
  return (
    <div className='bg-[#F1EFEC] pb-1'>
  {/* <div className="py-20 px-5 min-h-screen [background-image:radial-gradient(circle_at_center,_#F1EFEC,_#85CEE5)] mb-6">
  <div className="text-8xl font-extrabold text-center w-[80%] mx-auto text-black">
    we don’t just build brands —
    <br />
    <div className="mt-3">we co-dream with you.</div>
  </div>
</div> */}
<DreamSection/>
          <Section3/>

      {/* <div className='min-h-[90vh] transition-opacity duration-1000 ease-out' 
        data-aos="fade-up">
        <h1 className='text-7xl font-bold text-center my-12'> OUR MISSION- BEYOND TEMPLATES</h1>
        <div className='w-[70%] font-medium text-3xl mx-auto my-10'>
          <p className='text-start'>In a world where AI templates risk turning brands into digital duplicates, we step in with a hybrid approach — combining smart automation, intuitive tools, and emotionally intelligent strategy.
...
We do this by embedding deep into your vision, designing systems that convert quietly, creating content that resonates deeply, and shaping experiences that grow your business with intention — not imitation.</p>
        </div>
      </div> */}

      <Section4/>

    {/* <div  className='transition-opacity min-h-[70vh] mt-44 duration-1000 ease-out' 
        data-aos="fade-up">
      <h1 className='font-bold text-7xl text-center my-10'>OUR VISION : Built with purpose</h1>
      <div className='w-[70%] font-medium text-3xl mx-auto mt-10 mb-20'>
      <p>
      To define digital growth by building emotionally intelligent, culturally resonant, and automation-empowered brand ecosystems—crafted for timeless relevance. At Urban Orbit, we blend the precision of data, the power of AI, and the soul of storytelling to ensure every brand feels distinct, scales with purpose, and leaves a legacy in an era of algorithmic sameness.
      </p>
      </div>
    </div> */}
    ...
    <div className="flex flex-col items-center justify-center min-h-screen  text-white overflow-hidden pt-[80px] ease-out" data-aos="fade-up">
      ...
      <div className="relative w-full max-w-7xl h-[520px] px-8 overflow-hidden transition-opacity duration-1000 ease-out"
        data-aos="fade-up">
        <div className="relative h-full flex items-center justify-center ">

          {/* Left Card (For Desktop) */}
          <div
            className={`absolute w-[400px] h-[460px] bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700/30 rounded-xl px-8 py-6 transition-all duration-500 ease-out ${transitionClass} hidden md:block`}
            style={{
          ...
          <div
            className={`absolute w-[400px] h-[460px] bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700/30 rounded-xl px-12 py-8 transition-all duration-500 ease-out ${transitionClass} hidden md:block`}
            style={{
   ...
   <div>
    <Section6/>
          ...
          <div className='transition-opacity duration-1000 mt-44 ease-out min-h-[60vh]' 
        data-aos="fade-up">
    ...
    <div className='transition-opacity min-h-[80vh] mt-96 duration-1000 ease-out text-center my-20' 
        data-aos="fade-up">
