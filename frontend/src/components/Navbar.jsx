...
//   // New: handle Enter key press to redirect
...
//             <Link
//               to="/about"
//               className={`transition-colors ${isActive('/about') ? 'text-blue-400 font-semibold' : 'hover:text-blue-400'}`}
//             >
//               About
//             </Link>
//           </li>
...
//             <Link
//               to="/contact"
//               className={`transition-colors ${isActive('/contact') ? 'text-blue-400 font-semibold' : 'hover:text-blue-400'}`}
//             >
//               Contact
//             </Link>
//           </li>
...
//             <Link
//               to="/blog"
//               className={`transition-colors ${isActive('/blog') ? 'text-blue-400 font-semibold' : 'hover:text-blue-400'}`}
//             >
//               Blog
//             </Link>
//           </li>
